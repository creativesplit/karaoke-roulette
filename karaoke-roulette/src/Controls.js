  ...
  window.location.reload()
    ...
    render() {
      ...
      console.log(this.state.randomSong)
        ...
        <p className='instructions'> Each peson in your group should select a few songs and then hit the Spin button <br /><br />
        A song will be randomly selected for the next person up <br /><br />
        If you dont want to sing the song you got, you can hit the Truth button<br /><br />
        The Truth button will ask you to tell a story <br /><br />
        Once you hit the Truth button, you have to tell the story. Good luck!<br /></p>
        </div>
        ...
        <button onClick= {this.reload} className='reload'>Clear Songs</button>
        </div>
        </div>
